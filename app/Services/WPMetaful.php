...
class WPMetaful
{
    ...
    /**
     * Get the repeater key. Useful for ouputing different
     * types of fields inside of a repeater
     *
     * @param string $field
     * @param int    $item_key
     * @param string $repeaterName
     ...
     *
     * @param string $repeaterName Name of repeater field
     *
     * @return string
     */
