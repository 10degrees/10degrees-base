...
class Login
{
	public function __construct()
	{
		...
		add_filter( 'login_headertitle', [$this, 'login_logo_url_title'] );
	...
	{
	    echo '<link rel="stylesheet" type="text/css" href="' . get_stylesheet_directory_uri() . '/assets/css/wp-login.css" />';
	}
